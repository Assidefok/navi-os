...
Sistema de coneixement estructurat estil Obsidian.

## Categories

## 🤖 [[AI-News/index.md|AI News]]

Artificial Intelligence and Machine Learning news

- **Entrades totals:** 8
- **Darrera entrada:** 2026-04-04
...
```
memory/
├── index.md                    # Aquest index
├── AI-News/
│   ├── index.md                # Index de noticies IA
│   └── YYYY-MM-DD-HH.MM.md    # Entrades individuals
├── World-News/
│   ├── index.md                # Index de noticies mundials
│   └── YYYY-MM-DD-HH.MM.md
└── Iran-War/
│   ├── index.md                # Index de guerra Iran
│   └── YYYY-MM-DD-HH.MM.md
```
...
---
*Generat per Navi OS | 2026-04-04 23:10*